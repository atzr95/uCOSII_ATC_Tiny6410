...
#define OS_LOWEST_PRIO           254//30    /* Defines the lowest priority that can be assigned ...           */
                                       /* ... MUST NEVER be higher than 254!                             */

#define OS_MAX_EVENTS            256 //20    /* Max. number of event control blocks in your application        */
#define OS_MAX_FLAGS             256 //10    /* Max. number of Event Flag Groups    in your application        */
#define OS_MAX_MEM_PART          256 //25    /* Max. number of memory partitions                               */
#define OS_MAX_QS                256 //25    /* Max. number of queue control blocks in your application        */
#define OS_MAX_TASKS             56   //20    /* Max. number of tasks in your application, MUST be >= 2         */
